...
@implementation EnergiAppDelegate
...
//    [self showMessage:@"You're now logged out of Facebook." withTitle:@""];
//}
//
//// Show the user the logged-in UI
//-(void)userLoggedIn{
//    // Welcome message
//    [self showMessage:@"You're now logged in to Facebook." withTitle:@"Welcome!"];
//}
//
...
//        EnergiAppDelegate* appDelegate = [UIApplication sharedApplication].delegate;
